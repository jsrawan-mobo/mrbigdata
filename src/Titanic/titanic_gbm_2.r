...
summary(mo1gbm,n.trees=mo1gbm$n.trees) # based on the estimated best number of trees
...
write.csv(YhattrainBool, "titanic_2_gbm_train.csv", row.names=FALSE, col.names=FALSE)
...
write.csv(YhattestBool, "titanic_2_gbm_test.csv", row.names=FALSE, col.names=FALSE)
